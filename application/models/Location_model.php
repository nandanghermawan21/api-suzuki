...
class Location_model extends CI_Model
{
	...
	public function  fromJson($json): Location_model
	{
		...
		if (isset($json[$this->createDateJsonKey()])) { //DateTime::ATOM
			$data->createDate =  date_create(date(DATE_ATOM, strtotime($json[$this->createDateJsonKey()]))) + "Z";  //  DateTime::createFromFormat(DateTime::ISO8601, $json[$this->createDateJsonKey()]);
		}
